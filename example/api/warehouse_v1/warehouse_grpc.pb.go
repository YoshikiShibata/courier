...
func (c *warehouseClient) ListProducts(ctx context.Context, in *ListProductsRequest, opts ...grpc.CallOption) (*ListProductsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Warehouse/ListProducts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *warehouseClient) ShipProduct(ctx context.Context, in *ShipProductRequest, opts ...grpc.CallOption) (*ShipProductResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Warehouse/ShipProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Warehouse_ListProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Warehouse/ListProducts",
	}
...
func _Warehouse_ShipProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Warehouse/ShipProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
