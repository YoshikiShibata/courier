...
func (m *ListProductInventoriesRequest) validate(all bool) error {
	...
	if m.GetNumOfProducts() < 1 {
		err := ListProductInventoriesRequestValidationError{
			field:  "NumOfProducts",
...
// Validate checks the field values on GetShippingStatusRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetShippingStatusRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetShippingStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetShippingStatusRequestMultiError, or nil if none found.
func (m *GetShippingStatusRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetShippingStatusRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetShippingStatusRequestMultiError(errors)
	}

	return nil
}

// GetShippingStatusRequestMultiError is an error wrapping multiple validation
// errors returned by GetShippingStatusRequest.ValidateAll() if the designated
// constraints aren't met.
type GetShippingStatusRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetShippingStatusRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetShippingStatusRequestMultiError) AllErrors() []error { return m }

// GetShippingStatusRequestValidationError is the validation error returned by
// GetShippingStatusRequest.Validate if the designated constraints aren't met.
type GetShippingStatusRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetShippingStatusRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetShippingStatusRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetShippingStatusRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetShippingStatusRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetShippingStatusRequestValidationError) ErrorName() string {
	return "GetShippingStatusRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetShippingStatusRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetShippingStatusRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetShippingStatusRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetShippingStatusRequestValidationError{}

// Validate checks the field values on GetShippingStatusResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetShippingStatusResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetShippingStatusResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetShippingStatusResponseMultiError, or nil if none found.
func (m *GetShippingStatusResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetShippingStatusResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetShippingStatusResponseMultiError(errors)
	}

	return nil
}

// GetShippingStatusResponseMultiError is an error wrapping multiple validation
// errors returned by GetShippingStatusResponse.ValidateAll() if the
// designated constraints aren't met.
type GetShippingStatusResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetShippingStatusResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetShippingStatusResponseMultiError) AllErrors() []error { return m }

// GetShippingStatusResponseValidationError is the validation error returned by
// GetShippingStatusResponse.Validate if the designated constraints aren't met.
type GetShippingStatusResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetShippingStatusResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetShippingStatusResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetShippingStatusResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetShippingStatusResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetShippingStatusResponseValidationError) ErrorName() string {
	return "GetShippingStatusResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetShippingStatusResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetShippingStatusResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetShippingStatusResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetShippingStatusResponseValidationError{}
